...
export const adminResourceConfigs: Record<string, AdminResourceConfig> = {
  ...
  enrollments: {
    ...
    title: 'Enrollments',
    singular: 'Enrollment',
    apiPath: buildApiPath('enrollments'),
    listPath: buildPath('enrollments'),
    fields: enrollmentFields,
    columns: [
      { key: 'studentId', label: 'Student', type: 'relation' },
      { key: 'courseId', label: 'Course', type: 'relation' },
      { key: 'status', label: 'Status', type: 'badge' },
      { key: 'progress', label: 'Progress %' },
      { key: 'certificateIssued', label: 'Certificate', type: 'boolean' },
